...
// Description : 本程序文本使用GB18030字符集
// 在项目CodeGB18030右键,properties->C/C++ Build->Settings->Tool Settings->Dialet->Other dialet flags,
//		加上-finput-charset=GB18030 -fexec-charset=GB18030编译选项，告诉编译器，源文件编码为GB18030
//============================================================================
...
//	char * WCharToChar1(const wchar_t * pwszBuffer, const int &nLen = 0);		//函数调用，引用参数设为缺省值，可否？
																		//只有为const int &nLen = 0,
